...
INSERT INTO dbo.ban_doc (ma_tai_khoan, ma_the, ho_ten, ngay_sinh, gioi_tinh, so_dien_thoai, dia_chi, loai_ban_doc, ngay_cap_the, ngay_het_han, trang_thai_the)
VALUES
((SELECT ma_tai_khoan FROM dbo.tai_khoan WHERE ten_dang_nhap = N'bd01'), N'THE001', N'Nguyễn Văn A', '2004-05-10', N'Nam', N'0909123456', N'TP.HCM', N'SinhVien', GETDATE(), DATEADD(YEAR, 1, GETDATE()), N'HoatDong');
GO
...
VALUES
((SELECT ma_phan_loai FROM dbo.phan_loai_tai_lieu WHERE ky_hieu = N'CNTT'), N'TL001', N'Lập trình C# căn bản', N'Trần Minh Quân', N'NXB Giáo Dục', 2023, N'SachIn', N'Sách cơ bản về C#', N'Data\\TaiLieu\\lap-trinh-csharp-can-ban.pdf', N'NoiBo', GETDATE()),
((SELECT ma_phan_loai FROM dbo.phan_loai_tai_lieu WHERE ky_hieu = N'CNTT'), N'TL002', N'Cơ sở dữ liệu SQL Server', N'Mai Quốc Huy', N'NXB Khoa Học', 2022, N'SachIn', N'Tài liệu về SQL Server', NULL, N'CongKhai', GETDATE()),
((SELECT ma_phan_loai FROM dbo.phan_loai_tai_lieu WHERE ky_hieu = N'KT'), N'TL003', N'Nguyên lý kế toán', N'Hồ Minh Sang', N'NXB Tài Chính', 2021, N'TaiLieuSo', N'Giáo trình kế toán', N'Data\\TaiLieu\\nguyen-ly-ke-toan.pdf', N'NoiBo', GETDATE());
GO

INSERT INTO dbo.ban_sao_tai_lieu (ma_tai_lieu, ma_vach, vi_tri_kho, trang_thai, ngay_nhap_kho, ghi_chu)
VALUES
((SELECT ma_tai_lieu FROM dbo.tai_lieu WHERE ma_doc = N'TL001'), N'BAR001', N'Kệ A1', N'Con', GETDATE(), N'Bản in mới'),
((SELECT ma_tai_lieu FROM dbo.tai_lieu WHERE ma_doc = N'TL001'), N'BAR002', N'Kệ A2', N'DangMuon', GETDATE(), N'Đang cho mượn'),
((SELECT ma_tai_lieu FROM dbo.tai_lieu WHERE ma_doc = N'TL002'), N'BAR003', N'Kệ B1', N'Con', GETDATE(), N'Sẵn sàng phục vụ'),
((SELECT ma_tai_lieu FROM dbo.tai_lieu WHERE ma_doc = N'TL003'), N'BAR004', N'Kệ C1', N'Con', GETDATE(), N'Tài liệu số tham khảo');
GO
...
((SELECT ma_ban_doc FROM dbo.ban_doc WHERE ma_the = N'THE001'),
 ...
 CAST(GETDATE() AS DATE), DATEADD(DAY, 14, CAST(GETDATE() AS DATE)), NULL, N'DangMuon', 0, N'Phiếu mượn mẫu');
GO
