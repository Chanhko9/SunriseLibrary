...
SELECT tk.ma_tai_khoan, N'THE001', N'Nguyễn Văn A', '2004-05-10', N'Nam',
       ...
       GETDATE(), DATEADD(YEAR, 1, GETDATE()), N'HoatDong'
...
SELECT tl.ma_tai_lieu, N'BAR001', N'Kệ A1', N'Con', GETDATE(), N'Bản in mới'
FROM dbo.tai_lieu tl WHERE tl.ma_doc = N'TL001'
UNION ALL
SELECT tl.ma_tai_lieu, N'BAR002', N'Kệ A2', N'DangMuon', GETDATE(), N'Đang cho mượn'
FROM dbo.tai_lieu tl WHERE tl.ma_doc = N'TL001'
UNION ALL
SELECT tl.ma_tai_lieu, N'BAR003', N'Kệ B1', N'Con', GETDATE(), N'Sẵn sàng phục vụ'
FROM dbo.tai_lieu tl WHERE tl.ma_doc = N'TL002'
UNION ALL
SELECT tl.ma_tai_lieu, N'BAR004', N'Kho số', N'Con', GETDATE(), N'Tài liệu số tham khảo'
FROM dbo.tai_lieu tl WHERE tl.ma_doc = N'TL003'
UNION ALL
SELECT tl.ma_tai_lieu, N'BAR005', N'Kệ C1', N'Con', GETDATE(), N'Sách văn học'
